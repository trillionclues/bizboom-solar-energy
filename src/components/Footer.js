...
const Footer = () => {
  return (
    <footer className='text-black py-3 flex flex-col justify-start items-start gap-4 w-full px-8 md:px-16 bg-[#C9DBB2] h-full pt-10'>
      <div className='footer flex flex-col gap-10'>
        <div className='flex flex-col md:flex-row justify-between items-start w-full mb-4'>
          ...
          >
            ...
            <h3 className='text-sm w-3/5'>
              Lorem ipsum dolor sit amet consectetur, adipisicing elit. Dolore
              aspernatur praesentium optio, alias exercitationem incidunt.
            </h3>
          </div>
          <div className='flex flex-row gap-24 justify-start items-start md:-ml-32 ml-auto'>
            ...
            <div className='about flex flex-col justify-center'>
              <h2 className='font-bold text-xl mb-5'>Services</h2>
              <ul className='text-sm flex flex-col gap-3'>
                <li>
            ...
            <div className='about flex flex-col justify-center'>
              <h2 className='font-bold text-xl mb-5'>Help</h2>
              <ul className='text-sm flex flex-col gap-3'>
                <li>
        ...
        <div className='social flex flex-row justify-between items-center -mt-6'>
          ...
          <div className='social-middle flex flex-row gap-5'>
            <div className='terms'>
